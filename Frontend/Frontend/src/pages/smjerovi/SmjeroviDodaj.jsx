...
export default function SmjeroviDodaj(){
    ...
    async function dodaj(smjer){
        //console.log(smjer); // ovdje ispisuje json objekt (atributi bez navodnika) - ne može ovo na swagger
        //console.log(JSON.stringify(smjer)); //ovdje ispisuje JSON format koji ide preko mreže (atributi s navodnicima) - ovo copy / paste u swagger
